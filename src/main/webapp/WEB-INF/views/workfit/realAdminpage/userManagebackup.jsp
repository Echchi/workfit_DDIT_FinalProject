                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                ...
                                <!-- <button type="button" class="dripicons-arrow-right" onclick="plusMember()">추가하기</button> -->
                            </div>
                            <!--기존 회원 테이블-->
                            <div class="col-5">
                                <button type="button" class="btn btn-light mb-2">Export</button>
                                <table id="scroll-vertical-datatable" class="apple3 table dt-responsive nowrap memberTbl">
                                    <thead>
                                        <tr>
                                            <th>순번</th>
                                            <th>사원번호</th>
...
<!--                                             <th>이메일</th> -->
                                    ...
                                    <tbody id="tbodyTag2">
                                    	<c:forEach items="${memList }" var="memberVO" varStatus="status">
	                                        <tr>
	                                        	<td>${status.count }</td>
	                                        	<td>${memberVO.memDeptId }</td>
	                                        	<td>${memberVO.memName }</td>
	                                        	<td>${memberVO.memJobGrade }</td>
